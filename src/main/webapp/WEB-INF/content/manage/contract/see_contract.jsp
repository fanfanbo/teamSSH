    	...
    	<form  method="post" id="form">
    		<table>
    			<tr>
    				...
    				<td>签约时间：</td>
    				<td>
    					<input class="easyui-datetimebox" name="contractVO.duetime" value="${contractVO.duetime }" data-options="readonly:true">
    				</td>
    			</tr>
    			<tr>
    				<td>来源商机：(单击选择)</td>
    				<td>
    					<select id="select" name="contractVO.businessid" disabled="disabled" style="background-color: rgb(255, 248, 220)">
    				...
    				<td>联系人：</td>
    				<td>
						<input type="hidden" name="contractVO.createUserId " value="${contractVO.createUserId}" data-options="readonly:true" >
    					<input type="text" name="contractVO.businessConnectionName" value="${contractVO.businessConnectionName}" id="connectionName" data-options="readonly:true">
    				</td>
    			</tr>
    			<tr>
    				<td>来源客户：</td>
    				<td><input type="text" name="contractVO.businessCustomerName" id="businessCustomerName" value="${contractVO.businessCustomerName }" data-options="readonly:true"></td>
    				<td></td>
    				<td></td>
    				<td></td>
    			</tr>
    			<tr>
    				...
    				<td>合同金额：</td>
    				<td>
    					<input name="contractVO.price" value="${contractVO.price }" type="text" data-options="readonly:true" style="background-color: rgb(255, 248, 220)">
    				</td>
    			</tr>
    			<tr>
    				<td class="text-title">合同生效日期：</td>
    				<td class="text-content">
    					<input name="contractVO.starttime" value="${contractVO.starttime }" class="easyui-datetimebox" data-options="readonly:true">
    				</td>
    				<td></td>
    				<td>合同到期时间：</td>
    				<td>
    					<input name="contractVO.endTime" value="${contractVO.endTime }"class="easyui-datetimebox" data-options="readonly:true">
    				</td>
    			</tr>
    			<tr>
    				<td>状态：</td>
    				<td><input type="text" name="contractVO.status" value="${contractVO.status}" disabled="disabled" style="background-color: rgb(255, 248, 220)"></td>
    				<td></td>
    				<td></td>
    				<td></td>
    			</tr>
    			...
    			<tr>
    				<td>合同描述：</td>
    				<td colspan="4"><textarea rows="4" cols="100%" name="contractVO.description" disabled="disabled" style="background-color: rgb(255, 248, 220)">${contractVO.description }</textarea></td>
    			</tr>
